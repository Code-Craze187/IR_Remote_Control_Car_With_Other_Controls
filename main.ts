...
function Motor () {
    if (value == irRemote.irButton(IrButton.Up)) {
        ...
        MiniCar.motor(Motorlist.M1, Direction1.Backward, 65)
        MiniCar.motor(Motorlist.M2, Direction1.Forward, 65)
    } else if (value == irRemote.irButton(IrButton.Right)) {
        MiniCar.motor(Motorlist.M1, Direction1.Forward, 65)
        MiniCar.motor(Motorlist.M2, Direction1.Backward, 65)
